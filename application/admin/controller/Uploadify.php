...
use app\admin\server\UploadifyServer;
...
class Uploadify extends Controller
{
    ...
    public function initialize()
    {
        ...
        $this->server = new UploadifyServer();
    }

    public function upload(Request $request){
        $func = $request::route('func');
        $path = $request::route('path');
        $image_upload_limit_size = $this->server->getUploadSize()[0];
        $fileType = $request::route('fileType');  //上传文件类型，视频，图片
        if($fileType == 'Flash'){
